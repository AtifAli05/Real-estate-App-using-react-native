...
export default function MapViewScreen({navigation,route}) {
  ...
  const [destination, setdestination] = React.useState({latitude:33.677497, longitude: 73.078691});
  ...
  //       url:`https://maps.googleapis.com/maps/api/place/textsearch/json?query=realEstate&location=${lat}%2C${lng}&radius=10000&key=AIzaSyDgT1yo3L2yTl2xOw3udWJLTFBgivSzmzU`,
  //       headers: { }
  //     };
  //     axios(config)
